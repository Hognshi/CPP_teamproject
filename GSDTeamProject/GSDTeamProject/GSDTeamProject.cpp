...
//public:
//	CheckHint();
//	void CheckHint_window_bed(string input)
//	{
//		if (input.compare("침대"))
//		{
//			침대 밑 확인 전 
...
//}
//
//void RoomNum(string &input)
//{
//		if (input.compare(">")) // 오른쪽 이동
//		{
//			door_switch();
//		}
